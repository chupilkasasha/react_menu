...
function App() {
  ...
  const items = [{ value: 'Главная', href: '/main', icon: 'home' },
                 { value: 'Услуги', href: '/cervice', icon: 'api' },
                 { value: 'Магазин', href: '/shop', icon: 'shop' },
                 { value: 'О нас', href: '/about', icon: 'diversity_3'},]
    ...
    <div className="App">
      ...
      <main>
        <p>
          ...
          букв и пробелов в абзацах, которое не получается при простой дубликации "Здесь ваш текст..
          Здесь ваш текст.. Здесь ваш текст.." Многие программы электронной вёрстки и редакторы HTML
      ...
      <Menu header={'Бургер меню'} items={items} active={menuActive} setActive={setMenuActive} />
    </div>
  );
}
